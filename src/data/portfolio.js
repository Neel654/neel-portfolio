...
export const experience = [
  {
    ...
    description:
      "Developed Python-based automation services integrated with SQL workflows and Azure/M365 APIs to support production and operational processes across the business. Improved reporting reliability, reduced manual administrative effort, and helped streamline internal decision-making by enhancing monitoring, data flow accuracy, and iterative process improvements in a manufacturing environment.",
  ...
  },
  {
    ...
    period: "Feb 2026",
    description:
      "Built SafeSense, a browser-based AI safety platform that combines MediaPipe, webcam input, motion sensors, and voice feedback to deliver real-time assistance across fitness, driving, and fall-detection use cases. Designed the system to run fully client-side with zero data offloading, enabling privacy-first computer vision and sensor-based monitoring for real-time safety feedback directly in the browser.",
  ...
  },
  {
    ...
    period: "Feb 2025",
    description:
      "Designed TTCare, an AI-driven predictive maintenance concept for public transit focused on reducing delays and improving service reliability through proactive infrastructure monitoring. Proposed a multi-layer architecture combining IoT-style sensor inputs, anomaly detection, failure prediction, and scheduling optimization agents to support data-informed maintenance planning and operational coordination.",
  ...
  },
  {
    ...
    description:
      "Built and improved Python- and SQL-based data pipelines to collect, process, and analyze operational KPI data for internal reporting and business review workflows. Increased data consistency, reduced manual reporting effort, and supported better visibility into operations by designing modular pipeline components, applying validation checks, and following SDLC-based improvement practices.",
